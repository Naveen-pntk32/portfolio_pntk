...
export function ContactSection() {
  return (
    <section id="contact" className="min-h-screen relative overflow-hidden font-avant-garde flex items-center py-16 sm:py-20 md:py-24 pb-28 sm:pb-32 md:pb-24">
      ...
      <div className="relative z-10 flex items-center justify-center h-full w-full py-8 sm:py-12">
        <div className="container mx-auto px-4 sm:px-6">
          <ScrollReveal offset={100} className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center [--duration:500ms]">
            {(isActive) => (
              <>
                {/* Left side - Contact */}
                <div className={clsx(
